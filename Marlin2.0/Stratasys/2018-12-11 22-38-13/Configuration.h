...
#define CUSTOM_MACHINE_NAME "Stratasys uPrint"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 53.33, 126, 400, 119.3 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 145, 145, 15, 45 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 700, 700, 300, 5000 }
...
#define Z_HOMING_HEIGHT -322   // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 0), (Y_MAX_POS - 150), 20 }
