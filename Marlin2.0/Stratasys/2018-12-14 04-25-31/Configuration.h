...
#define CUSTOM_MACHINE_NAME "Stratasys"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 53.33, 133.75, 1011.89, 418 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 130, 130, 12, 45 }
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 59          // Set Mesh bounds as an inset region of the bed
...
#define LCD_BED_LEVELING
  ...
  #define LCD_PROBE_Z_RANGE 30    // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 42                    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 262                   // Y point for Z homing when homing all axes (G28).
#endif
...
#define PREHEAT_2_LABEL       "ABSplus-P430"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 42), (Y_MAX_POS - 20), 5 }
  #define NOZZLE_PARK_XY_FEEDRATE 45    // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { 38, 253 }
  #define NOZZLE_CLEAN_END_POINT   { 46, 224 }
  ...
  #define NOZZLE_CLEAN_CIRCLE_MIDDLE { 42, 262 }
